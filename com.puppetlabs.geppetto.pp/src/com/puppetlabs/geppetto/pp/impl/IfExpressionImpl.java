 ...
 * <ul>
 * <li>{@link com.puppetlabs.geppetto.pp.impl.IfExpressionImpl#getCondExpr <em>Cond Expr</em>}</li>
 * <li>{@link com.puppetlabs.geppetto.pp.impl.IfExpressionImpl#getThenStatements <em>Then Statements</em>}</li>
...
public class IfExpressionImpl extends ExpressionImpl implements IfExpression {
	...
	public EList<Expression> getThenStatements() {
		if(thenStatements == null) {
			thenStatements = new EObjectContainmentEList<Expression>(Expression.class, this, PPPackage.IF_EXPRESSION__THEN_STATEMENTS);
		}
		...
		if(newCondExpr != condExpr) {
			...
			if(condExpr != null)
				msgs = ((InternalEObject) condExpr).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - PPPackage.IF_EXPRESSION__COND_EXPR, null, msgs);
			if(newCondExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PPPackage.IF_EXPRESSION__COND_EXPR, newCondExpr, newCondExpr));
	}

...
/**
 * An ILayoutManager adds handling of before/after composite dom nodes and expects a sequence of calls for a composite
 * node:
 * <ul>
...
public interface ILayoutManager extends ILayout {
	...
	/**
	 * Called after all children of a composite have been processed. This call is always performed (even if format of
	 * the composite
	 * returned true).
	 *
	 * @param styleSet

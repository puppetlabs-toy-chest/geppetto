...
public class PPStylesheetProvider extends DefaultStylesheetProvider {
	...
	public DomCSS get() {
		...
		final Selector optionalResourceEndBodySemicolon = Select.grammar(resourceExpressionAccess.getSemicolonKeyword_0_1_2_2(), //
		...
		final Selector interpolationEnd = Select.grammar(grammarAccess.getTextExpressionAccess().getRightCurlyBracketKeyword_1_3(), //
		...
		final StyleSet noSpaceUnlessWrappedNoLine = StyleSet.withImmutableStyles(styles.noSpaceUnlessWrapped(), styles.noLineBreak());
		...
		final StyleSet noSpaceOneLineOptionallyTwo = StyleSet.withImmutableStyles(styles.noSpaceUnlessWrapped(), styles.lineBreaks(1, 1, 2));
		...
		css.addRules(
			...
			Select.whitespaceAfter(Select.grammar(grammarAccess.getVirtualNameOrReferenceAccess().getExportedATBooleanParserRuleCall_1_0()))//
			.withStyle(noSpaceUnlessWrappedNoLine)//
			...
			Select.whitespaceAfter(Select.grammar(grammarAccess.getUnaryMinusExpressionAccess().getHyphenMinusKeyword_0()))//
			.withStyle(noSpaceUnlessWrappedNoLine)//
			...
			// --Selector Expression
			Select.whitespaceBefore(Select.grammar(grammarAccess.getSelectorExpressionAccess().getCommaKeyword_1_2_0_3()))//
			.withStyle(noSpaceUnlessWrappedNoLine)//
			.withRuleName("WsBeforeSelectorExpressionEndComma"), //

			Select.whitespaceAfter(Select.grammar(grammarAccess.getSelectorExpressionAccess().getCommaKeyword_1_2_0_2_0_0()))//
			...
			Select.whitespaceBefore(Select.grammar(grammarAccess.getFunctionCallAccess().getLeftParenthesisKeyword_1_0_0_1()))//
			...
			Select.whitespaceAfter(Select.grammar(grammarAccess.getRubyLambdaAccess().getVerticalLineKeyword_4()).and(inline)) //
			.withStyles(styles.oneSpace(), styles.indent(0), styles.noLineBreak()).withRuleName("WsAfterInlineRightRPipe"),
			...
			// Separator
			Select.whitespaceBefore(Select.grammar(grammarAccess.getSeparatorExpressionAccess().getSemicolonKeyword_1())) //
			.withStyles(styles.noSpace(), styles.noLineBreak()).withRuleName("WsBeforeSeparator"),

			// optional linebreak if non inline
			Select.whitespaceAfter( //
				Select.and(notInline, Select.grammar(grammarAccess.getSeparatorExpressionAccess().getSemicolonKeyword_1()))) //

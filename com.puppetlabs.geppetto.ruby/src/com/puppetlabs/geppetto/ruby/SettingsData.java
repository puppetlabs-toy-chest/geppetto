	...
	public final Setting[] settings = new Setting[] {
			setting(
				...
				"Mongrel servers default to 127.0.0.1 and WEBrick defaults to 0.0.0.0."), //
																	...
																	setting(
				"ca_days", "How long a certificate should be valid. This parameter is deprecated, use ca_ttl instead.",
				"", true), //

																		setting("ca_md", "The type of hash used in certificates.", "Default: md5"), //

																		setting(
				"ca_name", "The name to use the Certificate Authority certificate.", "Default: Puppet CA: $certname"), //
				...
				"Default: $statedir/classes.txt"), //
																																			setting(
				"client_datadir", "The directory in which serialized data is stored on the client.",
				"Default: $vardir/client_data"), //
																																					setting("clientbucketdir", "Where FileBucket files are stored locally.", "Default: $vardir/clientbucket"), //
																																					setting(
				"clientyamldir", "The directory in which client-side YAML data is stored.",
				...
				"Default: 120"), //
																																																	...
																																																	setting(
				"couchdb_url", "The url where the puppet couchdb database will be created",
				...
				"Default: $statedir/clientconfigs.sqlite3"), //
																																																							...
																																																							setting(
				"dbpassword", "The database password for caching. Only used when networked databases are used.",
				"Default: puppet"), //

																																																									setting("dbport", "The database password for caching. Only used when networked databases are used.", ""), //

																																																									setting(
				"dbserver", "The database server for caching. Only used when networked databases are used.",
				"Default: localhost"), //
				...
				""), //
																																																													setting(
				"dbuser", "The database user for caching. Only used when networked databases are used.",
				"Default: puppet"), //
				...
				"Default: -u"), //
																																																															...
																																																															setting(
				"downcasefacts", "Whether facts should be made all lowercase when sent to the server.",
				"Default: false"), //
																																																															setting(
				"dynamicfacts",
				...
				"Default: none"), //
																																																																							setting(
				"factdest", "Where Puppet should store facts that it pulls down from the central server.",
				...
				"Default: puppet://$server/facts/"), //
																																																																													...
																																																																													setting(
				"fileserverconfig", "Where the fileserver configuration is stored.",
				...
				"Default: false"), //
																																																																																							...
																																																																																							setting(
				"hostcert", "Where individual hosts store and look for their certificates.",
				...
				"Default: $ssldir/crl.pem"), //
																																																																																									setting(
				"hostcsr", "Where individual hosts store and look for their certificate requests.",
				"Default: $ssldir/csr_$certname.pem"), //
																																																																																											setting(
				"hostprivkey", "Where individual hosts store and look for their private key.",
				"Default: $privatekeydir/$certname.pem"), //
																																																																																													setting(
				"hostpubkey", "Where individual hosts store and look for their public key.",
				...
				"Default: false"), //
																																																																																																									...
																																																																																																									setting(
				"inventory_terminus", "Should usually be the same as the facts terminus", "Default: $facts_terminus"), //
				...
				"Default: $statedir/last_run_summary.yaml"), //
																																																																																																											setting(
				"lastrunreport", "Where puppet agent stores the last run report in yaml format.",
				...
				"Default: puppetvar"), //
																																																																																																																									setting(
				"ldapstring", "The search string used to find an LDAP node.",
				...
				"Default: 4294967290"), //
																																																																																																																																						setting(
				"mkusers", "Whether to create the necessary user and group that puppet agent will run as.",
				"Default: false"), //
																																																																																																																																						setting(
				...
				"Default: false"), //
																																																																																																																																																		setting(
				"passfile", "Where puppet agent stores the password for its private key. Generally unused.",
				"Default: $privatedir/password"), //
																																																																																																																																																				setting(
				"path", "The shell search path. Defaults to whatever is inherited from the parent process.",
				"Default: none"), //
																																																																																																																																																				setting("pidfile", "The pid file", "Default: $rundir/$name.pid"), //
																																																																																																																																																				setting(
				"plugindest", "Where Puppet should store plugins that it pulls down from the central server.",
				"Default: $libdir"), //
				...
				""), //
																																																																																																																																																														setting(
				"privatedir", "Where the client stores private certificate information.", "Default: $ssldir/private"), //
																																																																																																																																																														...
																																																																																																																																																														setting(
				"puppetdlockfile", "A lock file to temporarily stop puppet agent from doing anything.",
				"Default: $statedir/puppetdlock"), //
																																																																																																																																																																setting(
				"puppetdlog", "The log file for puppet agent. This is generally not used.",
				...
				"Default: store"), //
																																																																																																																																																																								setting(
				"reportserver", "(Deprecated for ‘report_server’) The server to which to send transaction reports.",
				"Default: $server", true), //
																																																																																																																																																																									setting(
				...
				"Default: http://localhost:3000/reports/upload"), //
																																																																																																																																																																											...
																																																																																																																																																																											setting(
				"requestdir", "Where host certificate requests are stored.", "Default: $ssldir/certificate_requests"), //
																																																																																																																																																																											setting(
				"resourcefile",
				...
				"Default: $confdir/auth.conf"), //
																																																																																																																																																																															setting(
				"route_file", "The YAML file containing indirector route configuration.",
				...
				"Default: $runinterval"), //
																																																																																																																																																																																			setting(
				"run_mode", "The effective ‘run mode’ of the application: master, agent, or user.", "Default: master"), //
				...
				"Default: 1800"), //
																																																																																																																																																																																					setting(
				"sendmail", "Where to find the sendmail binary with which to send email.",
				...
				"Default: false"), //
																																																																																																																																																																																											setting(
				"splaylimit", "The maximum time to delay before runs. Defaults to being the same as the run interval.",
				"Default: $runinterval"), //
																																																																																																																																																																																													setting(
				"ssl_client_header",
				...
				"Default: daemon"), //
																																																																																																																																																																																																													setting(
				"tagmap", "The mapping between reporting tags and email addresses.", "Default: $confdir/tagmail.conf"), //
																																																																																																																																																																																																													setting(
				"tags",
				...
				"Default: /var/lib/puppet"), //
																																																																																																																																																																																																																									setting(
				"yamldir", "The directory in which YAML data is stored, usually in a subdirectory.",
				"Default: $vardir/yaml"), //
